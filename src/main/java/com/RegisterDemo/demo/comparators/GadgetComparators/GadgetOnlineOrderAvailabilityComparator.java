...
public class GadgetOnlineOrderAvailabilityComparator implements GadgetComparator {
    @Override
    public int compare(Gadget o1, Gadget o2) {
        return Boolean.compare(o1.isOnlineOrderAvailable(), o2.isOnlineOrderAvailable());
    }
}
